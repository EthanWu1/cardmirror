...
export interface NativeFile {
  ...
  docId?: string;
  /** Persistent collaboration pointer. Anyone who can read the file can
   *  use this metadata to rejoin the encrypted shared document. */
...
export interface SerializeNativeOptions {
  ...
  docId?: string;
  /** Persistent collaboration pointer for shared `.cmir` documents. */
  sharedDoc?: SharedDocMetadata;
}
