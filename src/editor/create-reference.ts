...
import { serializeCardMirrorClipboardHtml } from './clipboard-export.js';
...
export async function createReference(
  ...
  // 4. Serialize to HTML with Word-friendly style metadata while
  // keeping the same data-* spans CardMirror parses on import.
  const html = serializeCardMirrorClipboardHtml(outputFragment, schema);
