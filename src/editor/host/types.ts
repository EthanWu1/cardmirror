...
export type EditorFileFormat = 'cmir' | 'docx' | 'cmflow';
...
export interface Host {
  ...
  /** Native window chrome command. Electron implements these for the
   *  frameless desktop shell; browser hosts no-op. The `close` command
   *  must go through the normal close event so unsaved-change prompts
   *  still run. */
